...
<!-- content -->
	...
	<div class="sub-container">
		<div class="writebox">
			<form name="my" method="post" action="/port/writepro.do" enctype="multipart/form-data" onsubmit="return check()">
				<table class="border-table">
					...
					<tr>
						...
						<td>
							...
							<span style="display:block; padding:10px 0;"><textarea name="content" id="content"></textarea></span>
						</td>
					</tr>
					<tr>
						<th>첨부</th>
